// var person = ["John", "Doe", 46]; 陣列(Array) 數組使用數字來訪問其“元素”。在此示例中，person[0] 返回John：
// var person = {firstName:"John", lastName:"Doe", age:46}; 字典(Dictionary) 對象使用名稱來訪問其“成員”。在此示例中， person.firstName 返回John：
